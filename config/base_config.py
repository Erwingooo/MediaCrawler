...
#
# 是否使用系统浏览器默认用户目录（复用已有登录态）
# macOS Chrome默认: ~/Library/Application Support/Google/Chrome
# macOS Edge默认:  ~/Library/Application Support/Microsoft Edge
USE_BROWSER_DEFAULT_PROFILE = True
